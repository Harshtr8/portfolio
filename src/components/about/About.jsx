      ...
      <div className="about__data grid">
        <div className="about__info">
          <p className="about__description">
            Greetings!
            <br />
            I'm Harsh & I'm a Fullstack developer with a passion for creating
            modern and efficient digital solutions. With expertise in
            technologies like React Js, Tailwind CSS, JavaScript, TypeScript, and
          ...
          <a
            href="/harshtripathiresume.pdf"
            download="harshtripathiresume.pdf"
            className="btn"
            target="_blank"
